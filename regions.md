...
| Параметры | Необходимость | Пояснение |
| --------- | ------------- | --------- |
| player    | Обязательно.  | Никнейм игрокв. |
...
| Параметры | Пояснение |
| --------- | --------- |
| minX      | Координата X по оси у точки min |
| minY      | Координата Y по оси у точки min |
| minZ      | Координата Z по оси у точки min |
| maxX      | Координата X по оси у точки max |
| maxY      | Координата Y по оси у точки max |
| maxZ      | Координата Z по оси у точки max |
