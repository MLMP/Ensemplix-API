...
## ``` GET /server/events/ ``` 
Различные события в жизни сервера.

### Параметры
| Параметры | Необходимость | Пояснение |
| --------- | ------------- | --------- |
| offset    | Опционально.  | Начало от куда делать выборку событий. По умолчанию 0. |
| importance | Опционально. | Важность событий, которые нужно выбрать. По умолчанию все письма. 1 - средней и высокой важности. 2 - только высокой важности. |
